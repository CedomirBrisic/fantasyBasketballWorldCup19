    ...
    render() {
        return (
            <Modal className="round-points-calc-modal-container" visible={this.props.showRoundPointsCalc} onClickBackdrop={this.props.closeRoundPointsCalcModal}>
                ...
                <h3>Game is composed of 16 days / 16 rounds...    First round is on 31st-August and last one is on 15th-September 2019
                </h3>
                <div className="label-wrapper">
                    <p>At the end of every round, top 10 TD Fantasy users for that day are awarded with F1WC points.</p>
                    <p>But to be in that top 10, you first need to submit your team composed of 7 basketball players.</p>
                    <p>Once when they finish their matches, their real life stats are their basis and points from first five are included in your team points for that round.<br />Other two are going to bench...</p>
                </div>
                <div className="stats-calc-container d-flex justify-content-between align-items-center">
                    ...
                    <div className="right-container">
                        <div className="set-rules-wrapper">
                            <p className="container-label">Player score points:</p>
