        ...
        return (
            <>
                <section className="rules-container">
                    ...
                    <h5><span className="rule-numer-order">#6 -</span> Samo statistika sa <a href="http://www.fiba.basketball/basketballworldcup/2019" target="_blank" rel="noopener noreferrer">FIBA web sajta</a> su merodavni</h5>
